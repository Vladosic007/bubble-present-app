...
export default function DrinkTemplatePage() {
  ...
  // 1. ЗАЩИТА ОТ БЕЛОГО ЭКРАНА VERCEL
  ...
  // 2. ТВОИ ЦЕНЫ И НАСТРОЙКИ (МОЛОЧНАЯ ЧЕРНИКА)
  ...
  // 5. РАСЧЕТ ИТОГОВОЙ ЦЕНЫ И СОСТАВА
    ...
    <div className="bg-[#FDFDFD] min-h-[100dvh] w-full flex justify-center overflow-y-auto overflow-x-hidden font-sans">
      <main className="w-full max-w-[370px] relative flex flex-col items-center pb-[120px]">
        ...
        <div className="relative w-[370px] h-[360px] shrink-0">
          <Image src={productImg} alt={productName} fill quality={100} className="object-cover" priority />
        ...
        <div className="w-full px-[12px] mt-[16px] mb-[16px] z-20">
          <h1 className="text-[20px] uppercase tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] text-transparent bg-clip-text leading-none font-benzin font-extrabold">
            {productName}
          </h1>
        </div>
        ...
        <div className="w-[346px] h-[150px] mb-[32px] bg-[#EEEEEE] border border-[#FFFFFF]/40 shadow-[0px_5px_5.7px_4px_rgba(255,0,140,0.25)] rounded-[25px] flex items-center justify-center z-20 backdrop-blur-[30px] box-border shrink-0">
          <div className="w-[322px] h-[130px] box-border overflow-y-auto no-scrollbar">
            <p className="text-[11px] text-[#272727] leading-[1.4] text-justify font-benzin font-medium uppercase opacity-80">
              Молочная черника — это летнее утро в стакане. Сочная, чуть терпкая черника и сладость клубники тонут в бархате свежего молока, создавая нежный ягодно-сливочный дуэт. А на дне — приятный сюрприз: на выбор упругие жемчужины тапиоки или сочные джус-боллы, которые дарят финальный аккорд наслаждения.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="w-full h-[52px] flex justify-between items-center shrink-0 cursor-pointer px-[16px]" onClick={() => setIsAddonsOpen(!isAddonsOpen)}>
            <div className="flex items-center justify-start">
              <span className="text-[18px] tracking-[0.02em] whitespace-nowrap bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none font-benzin font-extrabold uppercase">Дополнения</span>
            </div>
          ...
          <div className="w-[314px] h-[138px] mt-[16px] bg-[#AEAEAE]/20 rounded-[25px] flex flex-col box-border shrink-0" style={{ boxShadow: 'inset 0px 0px 0px 1px rgba(255, 255, 255, 0.4), 0px 5px 5.7px 4px rgba(255, 0, 140, 0.25)' }}>
            <div className="mt-[16px] ml-[16px] shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] whitespace-nowrap bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Тип</span>
            </div>
            <div className="w-full flex justify-between items-center mt-[16px] px-[16px] box-border shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Холодный</span>
            ...
            <div className="w-full flex justify-between items-center mt-[12px] px-[16px] box-border shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Горячий</span>
          ...
          <div className="w-[314px] h-fit pb-[16px] mt-[32px] bg-[#AEAEAE]/20 rounded-[25px] flex flex-col box-border shrink-0 transition-all duration-500 overflow-hidden" style={{ boxShadow: 'inset 0px 0px 0px 1px rgba(255, 255, 255, 0.4), 0px 5px 5.7px 4px rgba(255, 0, 140, 0.25)' }}>
            <div className="mt-[16px] ml-[16px] shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Добавки</span>
            </div>
            <div className="w-full flex justify-between items-center mt-[16px] px-[16px] shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Тапиока</span>
            ...
            <div className="w-full flex justify-between items-center mt-[12px] px-[16px] shrink-0 cursor-pointer font-benzin font-extrabold" onClick={() => setIsJuiceOpen(!isJuiceOpen)}>
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Джус боллы</span>
            ...
            <div className="w-full flex justify-between items-center mt-[12px] px-[16px] shrink-0 font-benzin font-extrabold">
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase">Сырная шапка</span>
              <div className="flex items-center gap-[10px] shrink-0">
        ...
        <div className="w-[346px] h-[56px] mb-[20px] z-20 shrink-0">
          {itemInCart ? (
            ...
            <button onClick={handleAddToCart} className="w-full h-full bg-[#FFD1F5]/40 backdrop-blur-xl border border-white/80 rounded-[25px] shadow-[0_4px_12px_rgba(255,0,140,0.15)] flex justify-center items-center active:scale-95 transition-transform">
              <span className="text-[20px] font-black tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] text-transparent bg-clip-text leading-none flex items-center gap-[12px] font-benzin uppercase">
                <span>В корзину</span>
              </span>
            </button>
          )}
