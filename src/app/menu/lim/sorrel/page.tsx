...
export default function LimonadeTemplatePage() {
  ...
  // ❗❗❗ ТУТ ПИШЕШЬ ID И ИМЯ ❗❗❗
  const productId = 'sorrel'; // 👈 Изменил ID, чтобы он совпадал с картинкой
  const productName = 'Щавелевый';       
  const productImg = '/images/sorrel.jpg'; // 👈 Изменил имя файла картинки на правильное!
    ...
    <div className="bg-[#FDFDFD] min-h-[100dvh] w-full flex justify-center overflow-y-auto overflow-x-hidden font-sans">
      <main className="w-full max-w-[370px] relative flex flex-col items-center pb-[120px]">
        ...
        <div className="relative w-[370px] h-[360px] shrink-0">
          {/* ❗ Здесь теперь подтягивается картинка из переменной productImg ❗ */}
        ...
        >
            ...
            <div className={`w-full flex flex-col overflow-hidden transition-all duration-500 ease-in-out ${isJuiceOpen ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
              {juiceFlavorsList.map((flavor, index) => (
                <div key={flavor} className={`w-full flex justify-between items-center px-[24px] shrink-0 ${index === 0 ? 'mt-[24px]' : 'mt-[16px]'}`}>
                  <span className="text-[16px] tracking-[0.02em] whitespace-nowrap bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block" style={{ fontFamily: "'Benzin', sans-serif", fontWeight: 800 }}>{flavor}</span>
                  <div className="flex items-center gap-[10px] shrink-0">
          ...
          <div className="w-[314px] h-fit pb-[16px] mt-[32px] bg-[#AEAEAE]/20 rounded-[25px] flex flex-col box-border shrink-0" style={{ boxShadow: 'inset 0px 0px 0px 1px rgba(255, 255, 255, 0.4), 0px 5px 5.7px 4px rgba(255, 0, 140, 0.25)' }}>
            ...
            <div className={`w-full flex justify-between items-center mt-[16px] px-[16px] shrink-0 transition-opacity duration-300 ${tapiocaSelected ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase" style={{ fontFamily: "'Benzin', sans-serif", fontWeight: 800 }}>Тапиока 2X</span>
              <div className="flex items-center gap-[10px] shrink-0">
            ...
            <div className={`w-full flex justify-between items-center mt-[12px] px-[16px] shrink-0 transition-opacity duration-300 ${juiceSelected ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
              <span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase" style={{ fontFamily: "'Benzin', sans-serif", fontWeight: 800 }}>Джус боллы 2X</span>
              <div className="flex items-center gap-[10px] shrink-0">
          ...
          <div className="w-[314px] h-fit pb-[20px] mt-[32px] bg-[#AEAEAE]/20 rounded-[25px] flex flex-col box-border shrink-0" style={{ boxShadow: 'inset 0px 0px 0px 1px rgba(255, 255, 255, 0.4), 0px 5px 5.7px 4px rgba(255, 0, 140, 0.25)' }}>
            ...
            <div className="w-full flex justify-between items-center mt-[16px] px-[16px] shrink-0">
              <div className="flex items-center"><span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase" style={{ fontFamily: "'Benzin', sans-serif", fontWeight: 800 }}>M</span><span className="text-[12px] tracking-[0.02em] text-[#949494] whitespace-nowrap leading-none block ml-[10px]" style={{ fontFamily: "'Benzin-Regular', sans-serif" }}>500 ml</span></div>
              <div className="flex items-center gap-[10px] shrink-0">
            ...
            <div className="w-full flex justify-between items-center mt-[12px] px-[16px] shrink-0">
              <div className="flex items-center"><span className="text-[16px] tracking-[0.02em] bg-gradient-to-r from-[#FF00EE] to-[#FF008C] bg-clip-text text-transparent leading-none block uppercase" style={{ fontFamily: "'Benzin', sans-serif", fontWeight: 800 }}>L</span><span className="text-[12px] tracking-[0.02em] text-[#949494] whitespace-nowrap leading-none block ml-[10px]" style={{ fontFamily: "'Benzin-Regular', sans-serif" }}>700 ml</span></div>
              <div className="flex items-center gap-[10px] shrink-0">
